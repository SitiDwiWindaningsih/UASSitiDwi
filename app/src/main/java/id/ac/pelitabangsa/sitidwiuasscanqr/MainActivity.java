...
public class MainActivity extends AppCompatActivity {
    ...
    private void showmenu() {
        ...
        fthree.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, activity.project.SitiDwiUASScanQR.ScanActivity.class);
        ...
        ftwo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, activity.project.SitiDwiUASScanQR.DataActivity.class);
                startActivity(intent);
            }
        });
